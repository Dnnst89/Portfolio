...
export default function ProductReview({ comment, score, user }) {
  ...
  return (
    <div className="border-b-2 border-grey-200/50 grid text-sm mb-5">
      <div className="w-full flex ">
        <h3 className="px-4 py-2 w-1/3 overflow-hidden whitespace-nowrap font-bold">{user}</h3>

        <div className="grid md:flex justify-around  md:flexitems-center whitespace-nowrap w-full md:w-2/3 m-auto">
          ...
          <p className="md:ml-2 text-sm font-medium text-gray-500 dark:text-gray-400 w-full ">
            {score} de 5 estrellas
          </p>
        </div>
      </div>
      <div className="px-4 py-2 w-6/6 text-grey-100">

        ...
        <nav aria-label="">
          <ul className="list-style-none flex">
            ...
            {Array.from({ length: lastPage - firstPage + 1 }, (_, i) => (
              <li key={i}>
                <button
                  className={`relative block rounded bg-primary-500 mx-1 px-3 py-1.5 text-sm font-medium text-primary-700 transition-all duration-300 ${firstPage + i === currentPage ? "bg-white" : ""
                    }`}

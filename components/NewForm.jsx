        ...
        if (data && data.usersPermissionsUser) {
            ...
            setUserInformation({
                ...
                idNumber:
                    "",
                idType:
                    data?.usersPermissionsUser?.data?.attributes?.idCard?.idType || "Física",
            });
        }
    }
                        ...
                        <form onSubmit={onSubmit}>
                            <div className="mt-[40px] mx-[30px]">
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("firstName", {
                                                            ...
                                                            minLength: {
                                                                value: 3,
                                                                message: 'La información es insuficiente, por favor pon tu nombre completo',
                                                            },
                                                            maxLength: {
                                                                value: 30,
                                                                message: 'El nomnre no puede tener más de 30 caracteres',
                                                            },
                                                        })}
                                                    ></input>
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("lastName", {
                                                            ...
                                                            minLength: {
                                                                value: 5,
                                                                message: 'La información es insuficiente, por favor pon tu apellido completo',
                                                            },
                                                            maxLength: {
                                                                value: 50,
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("phone", {
                                                            ...
                                                            minLength: {
                                                                value: 8,
                                                                message: 'El teléfono no puede tener menos de 8 dígitos',
                                                            },
                                                            maxLength: {
                                                                value: 8,
                                                                message: 'El teléfono no puede tener más de 8 dígitos',
                                                            },
                                                            pattern: {
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("postCode", {
                                                            ...
                                                            minLength: {
                                                                value: 5,
                                                                message: 'El código postal no puede tener menos de 5 dígitos',
                                                            },
                                                            maxLength: {
                                                                value: 5,
                                                    ...
                                                    ></input>
                                                    <p className="text-red text-xs">{errors.postCode?.message}</p>
                                                </div>
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("country", {
                                                            ...
                                                            minLength: {
                                                                value: 5,
                                                                message: 'El país no puede tener menos de 5 letras',
                                                            },
                                                            maxLength: {
                                                                value: 20,
                                                                message: 'El país postal no puede tener más de 20 letras',
                                                            },
                                                            pattern: {
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        {...register("province", {
                                                            ...
                                                            minLength: {
                                                                value: 5,
                                                                message: 'La provincia no puede tener menos de 5 letras',
                                                            },
                                                            maxLength: {
                                                                value: 20,
                                                                message: 'La provincia no puede tener más de 20 letras',
                                                            },
                                                            pattern: {
                                                                value: /^[^0-9]*$/, // Expresión regular que no permite números
                                                                message: 'No se permiten números en este campo',
                                                    ...
                                                    ></input>
                                                    <p className="text-red text-xs">{errors.province?.message}</p>
                                                </div>
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <input
                                                        ...
                                                        id="canton"
                                                        {...register("canton", {
                                                            required: { value: true, message: "El cantón es requerido" },
                                                            minLength: {
                                                                value: 5,
                                                                message: 'El cantón no puede tener menos de 5 letras',
                                                            },
                                                            maxLength: {
                                                                value: 20,
                                                                message: 'El cantón no puede tener más de 20 letras',
                                                            },
                                                            pattern: {
                                                                value: /^[^0-9]*$/, // Expresión regular que no permite números
                                                                message: 'No se permiten números en este campo',
                                                    ...
                                                    ></input>
                                                    <p className="text-red text-xs">{errors.canton?.message}</p>
                                                </div>
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <textarea
                                                        ...
                                                        {...register("addressLine1", {
                                                            required: { value: true, message: "La dirreción es requerida" },
                                                            minLength: {
                                                                value: 5,
                                                                message: 'La dirección es muy corta, por favor se más específico',
                                                            },
                                                            maxLength: {
                                                                value: 100,
                                                ...
                                                <div className="col-span-6 grid">
                                                    ...
                                                    <textarea
                                                        ...
                                                        {...register("addressLine2", {
                                                            minLength: {
                                                                value: 5,
                                                                message: 'La dirección es muy corta, por favor ser más específico',
                                                            },
                                                            maxLength: {
                                                                value: 100,
                                                    ...
                                                    {fisica ? (
                                                        <div className="col-span-6 grid">
                                                            ...
                                                            <input
                                                                ...
                                                                id="idNumber"
                                                                {...register("idNumber", {
                                                                    required: { value: true, message: "La dédula es requerida" },
                                                                    minLength: {
                                                                        value: 9,
                                                                        message: 'La cédula física no puede tener menos de 9 dígitos',
                                                                    },
                                                                    maxLength: {
                                                                        value: 9,
                                                                        message: 'La cédula física no puede tener más de 9 dígitos',
                                                                    },
                                                                    pattern: {
                                                                        value: /^[0-9]*$/, // Expresión regular que solo permite números
                                                                        message: 'Ingresa solo números',
                                                            ...
                                                            ></input>
                                                            <p className="text-red text-xs">{errors.idNumber?.message}</p>
                                                        </div>
                                                    ) : (<div className="col-span-6 grid">
                                                        <label htmlFor="idNumber">Cédula</label>
                                                        <input
                                                            ...
                                                            {...register("idNumber", {
                                                                ...
                                                                minLength: {
                                                                    value: 10,
                                                                    message: 'La cédula jurídica no puede tener menos de 10 dígitos',
                                                                },
                                                                maxLength: {
                                                                    value: 10,
                                                                    message: 'La cédula jurídica no puede tener más de 10 dígitos',
                                                                },
                                                                pattern: {
                                                                    value: /^[0-9]*$/, // Expresión regular que solo permite números
                                                                    message: 'Ingresa solo números',
                                ...
                                <div className="flex justify-center m-auto mt-8 mb-8 w-3/4 ">
                                    <input className="bg-pink-200 text-white rounded-sm p-2 w-[150px] whitespace-nowrap" type="submit" value={"Continuar"}></input>
                                </div>
                            </div>
                        </form>
                    ) : (

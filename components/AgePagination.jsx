      ...
      <nav aria-label="">
        <ul className="list-style-none flex">
                    ...
                    {noPages.map((noPage) => (
                        <li key={noPage}>
                            <button
                                className={`relative block rounded bg-primary-500 mx-1 px-3 py-1.5 text-sm font-medium text-primary-700 transition-all duration-300 bg${noPage === currentPage ? "-white" : ""
                                    }`}

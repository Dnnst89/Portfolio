...
const WhatsAppIconWithLink = () => (
  <div
    className="fixed bottom-8 right-8 p-2 rounded-lg bg-blue-500 text-white cursor-pointer
     transition-all duration-500 ease-in-out hover:scale-110 z-50"
